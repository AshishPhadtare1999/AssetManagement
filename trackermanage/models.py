...
class AssetType(models.Model):
    ...
    assettype=models.CharField(max_length=50,blank=False,null=False)
...
class ManageAsset(models.Model):
    assetname=models.CharField(max_length=50,blank=False,null=False)
    ...
    assetimage=models.ImageField(upload_to='images/',default=None)
